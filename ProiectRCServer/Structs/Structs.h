...
#ifndef PROIECTRCSERVER_STRUCTS_H
#define PROIECTRCSERVER_STRUCTS_H
...
struct LoginDTO {
    LoginDTO(char *username, char *password) {
...
struct NewsfeedItem:PostDTO
{
    ...
    char LastName[100];
    NewsfeedItem(){}
    NewsfeedItem(sqlite3_stmt* stmt){
...
#endif //PROIECTRCSERVER_STRUCTS_H
